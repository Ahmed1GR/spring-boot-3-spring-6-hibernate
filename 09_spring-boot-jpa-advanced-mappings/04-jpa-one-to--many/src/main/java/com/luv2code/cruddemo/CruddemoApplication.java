...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		// find a student
		int theId = 2;
		Student tempStudent = appDAO.findStudensAndCoursesByStudentId(theId);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		System.out.println("The associated students are: " + tempCourse.getStudents());
...
// All Of This Is Just for tisting